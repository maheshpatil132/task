...
const Querie = () => {
  ...
  return (
    <div onClick={()=>setShow(!show)} className='my-8 w-full gap-2 mx-auto bg-slate-100 rounded-xl shadow-sm py-4 px-8 flex flex-col'>
                <div  className=' font-semibold items-center flex justify-between'>
                    <h1 className=' text-xl font-semibold text-[#2D2D2D]'>Can I cancel my subscrition?</h1>
